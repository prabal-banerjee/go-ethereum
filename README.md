Ethereum fork used to implement [Blockchain Enabled Privacy Preserving Data Audit](https://arxiv.org/abs/1904.12362). Edited `core/vm/contracts.go` to add a pre-compiled contract.
